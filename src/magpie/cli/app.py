...
from magpie.cli.commands import agent, analyze, journal, positions, report, rules, watchlist  # noqa: E402
...
app.add_typer(watchlist.app, name="watchlist", help="Manage the symbol watchlist.")
